...
def test_transaction_preview_money_value_parsing():
    options = MoneyValueParserOptions(parsing_type=MoneyValueParsingType.FROM_TRANSACTION_PREVIEW)
...
def test_order_preview_money_value_parsing():
    options = MoneyValueParserOptions(parsing_type=MoneyValueParsingType.FROM_ORDER_PREVIEW)
